...
WantedBy=multi-user.target" > /lib/systemd/system/bulletbot.service 
    ...
    if [[ -f $start_script_exists && -f $start_service_exists ]] 2>/dev/null; then
        ...
        bash installers/Debian-Ubuntu/autorestart/autorestart-updater.sh
    fi
    ...
    # user to install them using the options below
        ...
        case $option in
            1)
                ...
                ;;
            2)
                bash installers/Debian-Ubuntu/mongodb-installer.sh
                clear
                ;;
            3)
                export option
                bash installers/Debian-Ubuntu/nodejs-installer.sh
                clear
                ;;
            4)
                export option
            ...
            5)
                ...
                bash installers/Debian-Ubuntu/setup/bot-config-setup.sh
                clear
                ;;
            6)
                echo -e "\nExiting..."
        ...
        case $option in
            ...
            2)
                ...
                bash installers/Debian-Ubuntu/bb-start-modes/run-in-background.sh
                clear
                ;;
            3)
                export bullet_status
                ...
                bash installers/Debian-Ubuntu/bb-start-modes/run-in-background-autorestart.sh
                clear
                ;;
            4)
                export bullet_status
